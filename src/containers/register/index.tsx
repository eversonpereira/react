        ...
        <Form>
          <Form.Group widths='equal' style={{ alignItems: 'flex-end' }} >
            <Form.Field>
              ...
              <input value={zipcode || ''} maxLength={8} name='zipcode' onChange={handleForm} placeholder='Ex 14405100' />
            </Form.Field>
            <Form.Field>
              <Cep zipCode={zipcode} />
            </Form.Field>
          ...
          <Form.Group widths='equal' style={{ alignItems: 'flex-end' }} >
            <Form.Field>
              ...
              <input value={github || ''} maxLength={100} name='github' onChange={handleForm} placeholder='Ex eversonpereira' />
            </Form.Field>
            <Form.Field>
